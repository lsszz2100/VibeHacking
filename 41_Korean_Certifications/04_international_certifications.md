...
**보안 자격증**은 보안 지식과 기술 수준을 공식적으로 증명하는 수단입니다.

**취업/커리어 관점:**
```
국내 취업:
  정보보안기사: 공공기관, 금융기관 채용 우대
  CISSP: 대기업 CISO/보안팀장 필수

외국계 기업/해외:
  OSCP: 침투 테스트 직군 거의 필수
  CISSP: 글로벌 보안 경력 증명
  CompTIA Security+: 미국 국방부 요구 자격
```
...
[입문자 - 취업 준비]
  CompTIA Security+ → 정보보안기사 → CISSP
  
[침투 테스터/해커 지망]
  정보보안기사 → CEH → OSCP → OSED/OSWE
  
[보안 관리자/컨설턴트]
  정보보안기사 → ISMS-P 심사원 → CISSP → CISM
  
[클라우드 보안]
  AWS Security Specialty → CCSP → CISSP
```
...
고비용 자격증:
  OSCP: $1,499 + 학습 시간
  CISSP: $749 시험 + CPE 유지 비용
  
저비용 자격증:
  국내 정보보안기사: ~10만원
  CompTIA Security+: ~50만원
  
투자 대비 가치:
  OSCP: 침투 테스트 직군에서 연봉 차이 뚜렷
  CISSP: 경력 5년+ 후 관리자 직군 진출에 필수
  국내 자격증: 공공/금융 취업 필수
```
