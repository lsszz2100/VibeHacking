...
> 🎮 **Browser-based, staged CTF wargame** — 5 tiers from novice to expert, with hints and exam-style progression. 24 challenges drawn from this repo's 75 sections. ([about](wargame/README.md) · available once GitHub Pages is enabled)
