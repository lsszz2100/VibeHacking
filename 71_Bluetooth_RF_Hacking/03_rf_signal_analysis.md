...
**최신 기법·통제 (2025–2026):**
- SDR+GNU Radio·Universal Radio Hacker로 미지 프로토콜 리버싱 — 리플레이/롤링코드 분석은 소유기기·허가대역 한정. 검증: 캡처가 재현 가능한 복조 절차와 함께 문서화됐는가
- 재밍·스푸핑은 법적 통제 대상 — 격리 RF 챔버/차폐 환경에서만 수행([[27_IoT_Hacking]])
