...
| 파일 | 내용 |
|------|------|
| [01_osi_tcpip.md](./01_osi_tcpip.md) | OSI 7계층, TCP/IP, 프로토콜, 서브넷팅, ARP, DNS |
| [02_packet_analysis.md](./02_packet_analysis.md) | Wireshark, tcpdump 실전 패킷 분석 및 공격 탐지 |
| [03_wireless_hacking.md](./03_wireless_hacking.md) | **무선 네트워크 해킹 — Wi-Fi 보안 완전 가이드** — Wi-Fi 해킹은 무선 네트워크의 보안 프로토콜 취약점을 이용해 암호화 키를 탈취하거나 네트워크에 무단 접속하는 기법입니다. 무선 신호는 공중에 떠다니기 때문에 물리적 접근 없이도 공... |
