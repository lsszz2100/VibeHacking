...
> 🎮 **워게임으로 점검**: 이론을 익혔다면 [브라우저 워게임](wargame/README.md)(`https://lsszz2100.github.io/VibeHacking/`)에서 실력을 확인하세요. 가짜 셸로 5개 보안 계층을 침투하는 터미널형 CTF 945문제 — AI CLI에게 "워게임 N번 힌트만 줘"처럼 물어볼 수도 있습니다.
...
> 🎮 **Test yourself in the wargame**: once you've learned the theory, check your skills in the [browser wargame](wargame/README.md) (`https://lsszz2100.github.io/VibeHacking/`) — a terminal-style CTF where you breach five security layers via a fake shell, 945 challenges. You can even ask an AI CLI for "just a hint on wargame #N".
...
> 🎮 **ワーゲームで力試し**: 理論を学んだら[ブラウザワーゲーム](wargame/README.md)（`https://lsszz2100.github.io/VibeHacking/`）で腕試しを。偽シェルで5つのセキュリティ層を突破するターミナル型CTF、全945問。AI CLIに「ワーゲームN番のヒントだけ」と聞くこともできます。
...
> 🎮 **用战争游戏检验**：学完理论后，在[浏览器战争游戏](wargame/README.md)（`https://lsszz2100.github.io/VibeHacking/`）中检验自己 —— 用伪 Shell 攻破五道安全层的终端式 CTF，共 945 题。你甚至可以让 AI CLI「只给战争游戏第 N 题一个提示」。
