...
|------|:---:|:------:|:--------:|
| `perimeter` 외곽 | **0** | 67 | 46% |
| `webserver` 웹서버 | **1** | 98 | 60% |
| `internal` 내부망 | **2** | 113 | 60% |
| `vault` 금고 | **3** | 120 | 58% |
| `core` 코어 | **4** | 127 | 72% |
...
총 **525문제**(분야: 웹 35 · 암호 35 · 시스템 35 · 포렌식 35 · 클라우드/컨테이너 35 · AI/LLM 35 · 네트워크 35 · 모바일 35 · 하드웨어·IoT 35 · 블루팀 탐지·대응 35 · 물리 보안 침투 35 · 자동차 해킹 35 · 제로 트러스트 35 · 블록체인·Web3 35 · 액티브 디렉터리 35). 각 문제는 [Vibe Hacking 본 레포](../README.md)의 75개 섹션 주제와 연결됩니다.

Total **525 challenges** (web 35 · crypto 35 · system 35 · forensics 35 · cloud/container 35 · AI/LLM 35 · network 35 · mobile 35 · hardware & IoT 35 · blue team & detection 35 · physical security 35 · automotive 35 · zero trust 35 · blockchain & web3 35 · active directory 35); each maps to a topic from the [main repo](../README.md)'s 75 sections.
