...
**최신 기법·통제 (2025–2026):**
- 암호화 확산(TLS1.3·QUIC/HTTP3·ECH)으로 평문 관찰 감소 — 메타데이터·핑거프린팅(JA4) 중심 분석. 검증: 암호화 트래픽에서 이상이 통계적으로 드러나는지 재현([[40_Threat_Hunting]])
- IPv6 기본활성·확장헤더가 우회/사각 유발 — 이중스택 정책·필터가 강제되는지 확인([[24_Network_Infrastructure_Security]])
