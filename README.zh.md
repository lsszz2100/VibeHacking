...
[![Sections](https://img.shields.io/badge/Sections-68-blueviolet)](#目录)
[![Files](https://img.shields.io/badge/Docs-370%2B%20Files-brightgreen)](#目录)
[![Lines](https://img.shields.io/badge/Lines-440%2C000%2B-orange)](#目录)
...
在 **仓库目录内** 运行 `claude` / `codex` / `gemini`，AI 会将全部 68 个章节作为上下文读取，成为你的自然语言辅导员。无需手动搜索文件，一句话即可完成学习与实践。
...
cd VibeHacking
python3 vhack.py list        # 浏览全部 68 个章节
```
...
```bash
# 浏览与学习
python3 vhack.py list                    # 全部 68 个章节列表
