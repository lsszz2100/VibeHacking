...
[![Play Wargame](https://img.shields.io/badge/Play_Wargame-terminal_infiltration·1085-9933ff)](https://lsszz2100.github.io/VibeHacking/)
...
> 🎮 **Browser terminal infiltration CTF** — drive a fake shell (`connect` · `cat` · `submit`) to breach 5 security layers of `vibe.corp` (perimeter→web→internal→vault→core) and clear 1085 challenges. Boot sequence, `ACCESS GRANTED` effects, matrix rain, sound, hints, KO/EN. Drawn from this repo's 75 sections. ([about](wargame/README.md) · available once GitHub Pages is enabled)
