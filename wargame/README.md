...
| **1 기초** | 고전 암호(ROT13/Hex/Caesar/Morse), 쿠키, HTTP, robots.txt | 8 | 5 |
| **2 중급** | SQLi·XSS·JWT·해시·Base32·LFI·리버싱 | 9 | 6 |
| **3 고급** | XOR/ROT47 암호, 포맷스트링, SSTI, YARA, AD, 포렌식 | 9 | 5 |
| **4 전문가** | 체인/이중 디코딩, 컨테이너 탈출, AES-GCM, JWT, AI 보안 | 7 | 5 |

총 **39문제**. 각 문제는 [Vibe Hacking 본 레포](../README.md)의 75개 섹션 주제와 연결됩니다.
