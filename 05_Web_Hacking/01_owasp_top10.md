...
**최신 기법·통제 (2025–2026):**
- OWASP Top 10(2021→차기)·API Top 10 병행이 표준 — 접근제어·SSRF 비중 상승. 검증: 각 통제가 런타임에 실제 강제되는지 재현([[12_Bug_Bounty]])
- SPA/API·마이크로서비스로 신뢰경계 분산 — 인가가 서버측에서 강제되는지 확인([[52_API_Security]])
