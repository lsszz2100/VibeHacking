...
> 💡 **바이브해킹 실습 랩 및 워게임 연계**:
> - **인터랙티브 실습 랩 04**: [`labs/04_cloud_container_lab/`](../labs/04_cloud_container_lab/) — AWS IMDSv1/v2 SSRF 자격증명 탈취, S3 버킷 공개 노출 및 변조, 컨테이너 탈출 실습 랩 (`python3 vhack.py lab start 04`, SSRF 웹: `http://localhost:8040`, K8s API: `http://localhost:8443`)
