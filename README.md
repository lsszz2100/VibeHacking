...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=700&size=18&duration=2600&pause=600&color=00FF41&center=true&vCenter=true&width=700&lines=75+Sections+%C2%B7+491%2B+Files+%C2%B7+530%2C000%2B+Lines;CTF+%C2%B7+Bug+Bounty+%C2%B7+Red+Team+%C2%B7+AI+Security;Hack+Smart.+Defend+Hard.;%EC%8B%A4%EC%A0%84+%EC%82%AC%EC%9D%B4%EB%B2%84%EB%B3%B4%EC%95%88+%EC%99%84%EC%A0%84+%EC%A0%95%EB%B3%B5)](https://github.com/lsszz2100/VibeHacking)
...
[![Lines](https://img.shields.io/badge/💻_LINES-530K%2B-FF8C00?style=for-the-badge&labelColor=0d0d0d)](#목차)
...
[![Play the Wargame](https://img.shields.io/badge/🎮_워게임_플레이-터미널_침투·100문제-9933FF?style=for-the-badge&labelColor=0d0d0d)](https://lsszz2100.github.io/VibeHacking/) &nbsp; [![Wargame source](https://img.shields.io/badge/🧩_워게임_소개-wargame/-555555?style=flat-square&labelColor=111111)](wargame/README.md)

> 🎮 **브라우저 터미널에서 즐기는 침투 CTF 워게임** — 가짜 셸(`connect`·`cat`·`submit`)로 표적 `vibe.corp`의 보안 계층 5개(외곽→웹서버→내부망→금고→코어)를 한 계층씩 뚫어 100문제를 클리어. 부팅 시퀀스·`ACCESS GRANTED` 연출·매트릭스 레인·사운드·힌트·한영 지원. 본 레포의 75개 섹션 주제 기반. ([소개](wargame/README.md) · GitHub Pages 활성화 후 접속 가능)
...
`claude` / `codex` / `gemini` 를 **레포 디렉토리 안에서** 실행하면 AI가 75개 섹션 전체를 읽고 자연어 튜터가 됩니다. `vhack` CLI 없이도 대화 한 줄로 학습·실습이 가능합니다.
...
cd VibeHacking
python3 vhack.py list        # 75개 섹션 목록 확인
```
...
```bash
# 학습 탐색
python3 vhack.py list                   # 전체 75개 섹션 목록
...
| # | 섹션 | 핵심 내용 | 난이도 | 파일 |
|:-:|------|-----------|:------:|:----:|
| 01 | [Linux 기초 & Kali Linux](#01-linux-기초--kali-linux) | 필수 명령어, Kali 셋업, Bash 스크립팅 | 🟢 | 6 |
| 02 | [네트워크 해킹](#02-네트워크-해킹) | OSI/TCP-IP, 패킷 분석, 무선 해킹 | 🟢 | 6 |
| 03 | [시스템 해킹](#03-시스템-해킹) | 비밀번호 크랙, Buffer Overflow, AD | 🟡 | 6 |
| 04 | [리버스 엔지니어링](#04-리버스-엔지니어링) | 어셈블리, x64dbg, PE 구조, Ghidra | 🟡 | 6 |
| 05 | [웹 해킹](#05-웹-해킹) | OWASP Top 10, SQLi, XSS/CSRF, WAF 우회 | 🟡 | 6 |
| 06 | [악성코드 분석](#06-악성코드-분석) | 정적/동적 분석, Volatility, Android | 🔴 | 6 |
| 07 | [디지털 포렌식](#07-디지털-포렌식) | 포렌식 절차, Windows 아티팩트, 네트워크 | 🟡 | 6 |
| 08 | [파이썬 해킹](#08-파이썬-해킹) | 도구 개발, 네트워크 스캐너, 웹 자동화 | 🟡 | 6 |
| 09 | [익스플로잇 기법](#09-익스플로잇-기법) | ROP Chain, SEH, Linux BOF, 힙 익스플로잇 | 🔴 | 6 |
| 10 | [침투 테스트 방법론](#10-침투-테스트-방법론) | 모의해킹 절차, OSINT 정찰, 보고서 작성 | 🟡 | 6 |

### 🟠 OFFENSIVE CORE — AI·전문 공격

| # | 섹션 | 핵심 내용 | 난이도 | 파일 |
|:-:|------|-----------|:------:|:----:|
| 11 | [**AI 기반 사이버보안**](#11-ai-기반-사이버보안) | Claude Opus 4, GPT-4o, LLM 취약점, CTF 자동화 | ⚫ | 6 |
| 12 | [버그바운티](#12-버그바운티) | 방법론, Burp Suite 심화, 자동화 도구 | 🔴 | 6 |
| 13 | [SOC & Blue Team](#13-soc--blue-team) | SOC 운영, Splunk·QRadar, 위협 헌팅 | 🔴 | 6 |
| 14 | [클라우드 보안](#14-클라우드-보안) | AWS/Azure/GCP 공격, K8s, 체크리스트 | 🔴 | 6 |
| 15 | [WiFi 해킹](#15-wifi-해킹) | WPA2 크랙, PMKID, Evil Twin | 🟡 | 6 |
| 16 | [암호학](#16-암호학) | AES/RSA 취약점, 해시 공격, Padding Oracle | 🔴 | 6 |
| 17 | [레드팀 운영](#17-레드팀-운영) | C2 프레임워크, 피싱, API 해킹 | ⚫ | 6 |
| 18 | [DevSecOps](#18-devsecops) | SAST/SCA/DAST, 컨테이너, CI/CD | 🔴 | 6 |
| 19 | [어셈블리 언어](#19-어셈블리-언어) | x86/x64, 셸코드 개발, 디스어셈블리 | 🔴 | 6 |
| 20 | [셸 스크립팅](#20-셸-스크립팅) | Bash 자동화, 침투 자동화, C2 소켓 | 🟡 | 6 |
| 21 | [Windows 익스플로잇](#21-windows-익스플로잇) | 내부 구조, 권한 상승, 방어 우회 | 🔴 | 6 |
| 22 | [패스워드 크래킹](#22-패스워드-크래킹) | Hashcat/John, 레인보우, 패스워드 스프레이 | 🟡 | 6 |

### 🟡 ADVANCED TECHNIQUES — 심화 공격

| # | 섹션 | 핵심 내용 | 난이도 | 파일 |
|:-:|------|-----------|:------:|:----:|
| 23 | [Database Hacking](#23-database-hacking) | Oracle/MySQL 공격, DB 권한 상승 | 🔴 | 6 |
| 24 | [네트워크 인프라 보안](#24-네트워크-인프라-보안) | DNS/메일 공격, SSH 터널링 | 🔴 | 6 |
| 25 | [위협 인텔리전스](#25-위협-인텔리전스) | CTI, OSINT, 인시던트 대응 | 🔴 | 6 |
| 26 | [Linux Hardening](#26-linux-hardening) | iptables, PAM, KISA 평가 | 🟡 | 6 |
| 27 | [IoT 해킹](#27-iot-해킹) | 펌웨어 분석, UART/JTAG | 🔴 | 6 |
| 28 | [모바일 해킹](#28-모바일-해킹) | Android/iOS, Frida, SSL Pinning | 🔴 | 6 |
| 29 | [컨테이너/쿠버네티스 보안](#29-컨테이너쿠버네티스-보안) | Docker 탈출, K8s RBAC | 🔴 | 6 |
| 30 | [취약점 연구](#30-취약점-연구) | AFL++/libFuzzer, 고급 익스플로잇 | ⚫ | 6 |
| 31 | [AI/ML 시스템 보안](#31-aiml-시스템-보안) | 적대적 예제, 프롬프트 인젝션, LLM | ⚫ | 6 |
| 32 | [네트워크 장비 해킹](#32-네트워크-장비-해킹) | Cisco IOS, L2 공격, BGP 조작 | ⚫ | 6 |
| 33 | [OSINT & 소셜 엔지니어링](#33-osint--소셜-엔지니어링) | 정보 수집, 피싱 인프라 | 🔴 | 6 |
| 34 | [하드웨어 해킹](#34-하드웨어-해킹) | UART/JTAG/SPI, 사이드채널 | ⚫ | 6 |
| 35 | [공급망 공격](#35-공급망-공격) | 패키지 독화, CI/CD 침해, SolarWinds | ⚫ | 6 |
| 36 | [자동차 해킹](#36-자동차-해킹) | CAN 버스, ECU, V2X | ⚫ | 6 |
| 37 | [ICS/SCADA 보안](#37-icsscada-보안) | SCADA 공격, PLC 익스플로잇, OT | ⚫ | 6 |
| 38 | [Cloud Native 보안](#38-cloud-native-보안) | eBPF, CNAPP, 컨테이너 탈출 | ⚫ | 6 |
| 39 | [Zero Trust 아키텍처](#39-zero-trust-아키텍처) | BeyondCorp, mTLS, SASE | 🔴 | 6 |
| 40 | [위협 헌팅](#40-위협-헌팅) | MITRE ATT&CK, KQL/SPL 100+, SOAR | 🔴 | 6 |

### 🟢 SPECIALIST DOMAINS — 전문 영역

| # | 섹션 | 핵심 내용 | 난이도 | 파일 |
|:-:|------|-----------|:------:|:----:|
| 41 | [한국 정보보안 자격증](#41-한국-정보보안-자격증) | 정보보안기사·ISMS-P·CISSP/OSCP 로드맵 | 🟡 | 6 |
| 42 | [블록체인/Web3 보안](#42-블록체인web3-보안) | EVM, 스마트 컨트랙트 감사, DeFi | ⚫ | 6 |
| 43 | [물리적 침투 테스트](#43-물리적-침투-테스트) | 잠금 우회, RFID 클로닝, 사회공학 | 🔴 | 6 |
| 44 | [인시던트 대응/DFIR](#44-인시던트-대응dfir) | IR 플레이북, 메모리·디스크 포렌식 | 🔴 | 6 |
| 45 | [악성코드 개발](#45-악성코드-개발) | PE 구조, 셸코드, C2, AV/EDR 우회 | ⚫ | 6 |
| 46 | [CTF 기법](#46-ctf-기법) | PWN/REV/Web/Crypto, pwntools, angr | 🔴 | 6 |
| 47 | [모바일 포렌식](#47-모바일-포렌식) | Android/iOS 증거 추출, MVT | 🔴 | 6 |
| 48 | [위협 모델링](#48-위협-모델링) | STRIDE/PASTA/DREAD, Attack Tree | 🔴 | 6 |
| 49 | [레드팀 인프라](#49-레드팀-인프라) | C2, 도메인 프론팅, OPSEC, Terraform | ⚫ | 6 |
| 50 | [게임 해킹](#50-게임-해킹) | 메모리 조작, Cheat Engine, 패킷 분석 | 🔴 | 6 |
| 51 | [브라우저 확장 보안](#51-브라우저-확장-보안) | MV3, 악성 확장 분석, Content Script XSS | 🔴 | 6 |
| 52 | [API 보안](#52-api-보안) | OWASP API Top 10, GraphQL, OAuth2 | 🔴 | 6 |
| 53 | [서버리스 보안](#53-서버리스-보안) | Lambda 공격, 이벤트 인젝션, IAM 남용 | 🔴 | 6 |
| 54 | [Active Directory 공격](#54-active-directory-공격) | Kerberoasting, DCSync, Golden Ticket | ⚫ | 6 |
| 55 | [탐지 우회 기법](#55-탐지-우회-기법) | AV/EDR 우회, syscall, 흔적 제거 | ⚫ | 6 |
| 56 | [AI 레드팀](#56-ai-레드팀) | 프롬프트 인젝션, 모델 추출, 적대적 예제 | ⚫ | 6 |
| 57 | [양자 암호학](#57-양자-암호학) | QKD, 후양자 알고리즘, NIST PQC | ⚫ | 6 |
| 58 | [클라우드 침해 대응](#58-클라우드-침해-대응) | Cloud IR, AWS/Azure/GCP 포렌식 | ⚫ | 6 |
| 59 | [공급망 보안](#59-공급망-보안) | SBOM, 의존성 혼동, 빌드 무결성 | ⚫ | 6 |
| 60 | [브라우저 보안 심화](#60-브라우저-보안-심화) | JS엔진 익스플로잇, 샌드박스 탈출 | ⚫ | 6 |
| 61 | [펌웨어 해킹](#61-펌웨어-해킹) | 펌웨어 추출, QEMU 에뮬레이션 | ⚫ | 6 |
| 62 | [자동차 보안](#62-자동차-보안) | CAN 버스, ECU, V2X, OTA 공격 | ⚫ | 6 |
| 63 | [OT/ICS 심화](#63-otICS-심화) | SCADA, PLC 익스플로잇, OT 방어 | ⚫ | 6 |
...
| 73 | [버그바운티 자동화](#73-버그바운티-자동화) | HackerOne, subfinder·nuclei 파이프라인, CVSS 리포트 | 🟣 | 6 |
| 74 | [코드 감사](#74-코드-감사) | Semgrep·CodeQL, Source/Sink 추적, CI/CD 보안 게이트 | 🟣 | 6 |
| 75 | [레드팀 보고서 작성](#75-레드팀-보고서-작성) | ATT&CK 매핑, 이중 독자 보고서, 디브리핑 | 🟣 | 6 |
...
├── 05_linux_security_tools.md       ← Linux 보안 도구 모음
└── 06_linux_ctf_practical_lab.md    ← 리눅스 CTF 실습 랩 — 권한상승·SUID·Cron·환경변수 종합
```
...
├── 05_network_exploitation_techniques.md ← 고급 네트워크 익스플로잇 기법
└── 06_network_ctf_lab.md    ← CTF 스타일 네트워크 해킹 실습
```
...
├── 05_system_defense_and_detection.md ← 시스템 공격 탐지 및 방어
└── 06_system_ctf_lab.md              ← CTF 스타일 시스템 해킹 실습
```
...
├── 05_advanced_unpacking_and_deobfuscation.md ← 고급 언패킹 및 난독화 해제
└── 06_reversing_ctf_lab.md             ← CTF 스타일 리버싱 실습
```
...
├── 05_web_security_tools_and_automation.md ← 웹 보안 도구와 자동화
...
├── 05_malware_defense_and_hunting.md ← 악성코드 방어 및 헌팅
└── 06_malware_ctf_practical_lab.md   ← 악성코드 분석 CTF 실습 랩 — 정적·동적 분석·언패킹·C2 탐지
```
...
├── 04_advanced_volatility.md             ← Volatility3 심화 — 프로세스 분석·네트워크·악성코드 탐지
├── 05_forensics_automation_and_tools.md  ← 포렌식 자동화 및 도구
└── 06_forensics_ctf_lab.md               ← 포렌식 CTF 실습 랩
```
...
├── 04_python_exploit_automation.md  ← Python 익스플로잇 자동화 — pwntools·ROPgadget·CTF 도구
├── 05_python_security_automation.md ← Python 보안 자동화 — Scapy·requests·paramiko·자동화 도구
└── 06_python_hacking_ctf_lab.md     ← Python 해킹 CTF 실습 랩
```
...
├── 04_format_string_exploits.md  ← 포맷 스트링 익스플로잇 심화 — 임의 읽기·쓰기·GOT 오버라이트
├── 05_exploit_defense_and_mitigation.md ← 익스플로잇 방어 및 완화 기법 — ASLR·DEP/NX·스택 카나리·CFG
└── 06_exploit_ctf_lab.md         ← 익스플로잇 기법 CTF 실습 랩
```
...
├── 05_pentest_reporting_and_remediation.md ← 침투 테스트 보고서 작성 및 조치 가이드 — CVSS·경영진 요약·조치 방법
└── 06_pentest_ctf_lab.md       ← 침투 테스트 방법론 CTF 실습 랩
```
...
├── 05_claude_gpt_cyber_integration.md ← AI 통합 — Claude + GPT-4o 보안 분석 도구 활용법
└── 06_ai_security_ctf_lab.md          ← CTF 스타일 AI 보안 실습
```
...
├── 05_advanced_vuln_chains.md     ← 버그바운티 고급 — 취약점 체인·서브도메인 테이크오버·계정 탈취
└── 06_bug_bounty_ctf_lab.md       ← 버그 바운티 CTF 실습 랩
```
...
├── 05_detection_engineering.md     ← 탐지 엔지니어링 — Sigma·MITRE ATT&CK 기반 룰 개발
└── 06_soc_ctf_lab.md               ← SOC/블루팀 CTF 실습 랩
```
...
├── 04_GCP_Azure_Pentest.md           ← GCP 및 Azure 침투테스트
├── 05_cloud_lateral_movement.md      ← 클라우드 횡이동 — 계정 피버팅·서비스 간 이동·탐지
└── 06_cloud_security_ctf_lab.md      ← 클라우드 보안 CTF 실습 랩
```
...
├── 04_Enterprise_WiFi_Attacks.md     ← 기업 WiFi 공격 (WPA2-Enterprise / RADIUS)
├── 05_rogue_ap_and_detection.md      ← 로그 AP·캡티브 포털·WiFi 모니터링 및 탐지
└── 06_wifi_ctf_lab.md                ← WiFi 해킹 CTF 실습 랩
```
...
├── 04_PKI_TLS_Attacks.md            ← PKI 인프라 및 TLS/SSL 공격
├── 05_crypto_implementation_attacks.md ← 암호화 구현 취약점 공격 — 패딩 오라클·타이밍 공격·약한 난수
└── 06_crypto_ctf_practical_lab.md   ← 암호학 CTF 실습 랩 — 고전암호·RSA·ECC·해시 종합
```
...
├── 04_C2_Infrastructure.md               ← C2(Command and Control) 인프라 구축 및 운영
├── 05_red_team_reporting.md              ← 레드팀 리포팅 — 결과 분석·익스플로잇 체인 문서화·경영진 보고서
└── 06_red_team_ctf_lab.md                ← 레드팀 운영 CTF 실습 랩
```
...
├── 04_Secret_Detection_and_SBOM.md ← 시크릿 탐지 및 SBOM(소프트웨어 자재 명세)
├── 05_supply_chain_security.md     ← 공급망 보안 — 의존성 공격·SLSA·서명 검증
└── 06_devsecops_ctf_lab.md         ← DevSecOps CTF 실습 랩
```
...
├── 04_ROP_Chain_Programming.md  ← ROP(Return-Oriented Programming) 체인 구성
├── 05_shellcode_analysis_and_detection.md ← 셸코드 분석 및 탐지 — 정적·동적 분석·시그니처 생성
└── 06_assembly_ctf_lab.md       ← 어셈블리 언어 CTF 실습 랩
```
...
├── 04_Advanced_Obfuscation_Evasion.md ← 셸 스크립트 난독화 및 탐지 우회
├── 05_bash_forensics_and_monitoring.md ← Bash 포렌식·모니터링 자동화 — 로그 분석·이상 탐지·인시던트 대응
└── 06_shell_ctf_lab.md               ← 쉘 스크립팅 CTF 실습 랩
```
...
├── 04_COM_Object_Hijacking.md           ← COM 객체 하이재킹 및 WMI 악용
├── 05_windows_persistence_detection.md  ← 윈도우 지속성 탐지 — 레지스트리·서비스·WMI 백도어 분석
└── 06_windows_ctf_lab.md                ← Windows 익스플로잇 CTF 실습 랩
```
...
├── 04_Credential_Stuffing_Automation.md ← 크리덴셜 스터핑 및 패스워드 분석 자동화
├── 05_password_policy_audit.md         ← 패스워드 정책 감사 — 약한 정책 탐지·해시 강도 분석·권고사항
└── 06_password_ctf_lab.md              ← 패스워드 크래킹 CTF 실습 랩
```
...
├── 04_nosql_and_cloud_db_attacks.md ← NoSQL 및 클라우드 DB 공격
├── 05_database_defense_and_hardening.md ← DB 방어 및 하드닝
└── 06_database_ctf_lab.md          ← 데이터베이스 해킹 CTF 실습 랩
```
...
├── 04_network_security_automation.md       ← 네트워크 보안 자동화
├── 05_network_defense_automation.md        ← 네트워크 방어 자동화 — IDS/IPS 튜닝·방화벽 자동화·네트워크 모니터링
└── 06_network_infra_ctf_lab.md             ← 네트워크 인프라 CTF 실습 랩
```
...
├── 04_cti_platform_operations.md   ← CTI 플랫폼 운영
├── 05_threat_intel_automation.md   ← 위협 인텔리전스 자동화 — MISP·OpenCTI·IOC 보강·STIX/TAXII
└── 06_threat_intel_ctf_lab.md      ← 위협 인텔리전스 CTF 실습 랩
```
...
├── 04_linux_security_auditing.md        ← Linux 보안 감사
├── 05_linux_hardening_automation.md     ← Linux 보안 강화 자동화 — CIS 벤치마크·Ansible·감사 스크립트
└── 06_linux_hardening_ctf_lab.md        ← Linux 하드닝 CTF 실습 랩
```
...
├── 04_RF_Zigbee_Attacks.md     ← RF/Zigbee/Z-Wave IoT 무선 프로토콜 공격
├── 05_iot_security_hardening.md ← IoT 보안 강화 — 펌웨어 서명·네트워크 격리·디바이스 감사
└── 06_iot_ctf_lab.md           ← IoT 해킹 CTF 실습 랩
```
...
├── 04_Mobile_Malware_Analysis.md   ← 모바일 악성코드 분석 (Android/iOS)
├── 05_mobile_app_security_testing.md ← 모바일 앱 보안 테스트 — 자동화 분석·런타임 후킹·API 감사
└── 06_mobile_ctf_lab.md            ← 모바일 해킹 CTF 실습 랩
```
...
├── 04_Service_Mesh_API_Gateway_Attacks.md ← 서비스 메시 및 API 게이트웨이 공격
├── 05_kubernetes_rbac_audit.md ← Kubernetes RBAC 감사 — 권한 분석·과도한 권한 탐지·정책 강화
└── 06_container_ctf_lab.md    ← 컨테이너 & 쿠버네티스 보안 CTF 실습 랩
```
...
├── 04_CVE_Writeup_Methodology.md       ← CVE 취약점 분석 및 PoC 작성 방법론
├── 05_responsible_disclosure.md        ← 책임감 있는 취약점 공개 — CVE 신청·조율·타임라인 관리
└── 06_vuln_research_ctf_lab.md         ← 취약점 연구 CTF 실습 랩
```
...
├── 05_ai_security_defense.md          ← AI/ML 보안 방어 — 적대적 견고성·모델 모니터링·OWASP LLM Top 10 완화
└── 06_ai_ml_ctf_lab.md                ← AI/ML 보안 CTF 실습 랩
```
...
├── 05_network_device_hardening.md        ← 네트워크 장비 보안 강화 — Cisco·Juniper 보안 설정·네트워크 장비 모니터링
└── 06_network_device_ctf_lab.md          ← 네트워크 장치 해킹 CTF 실습 랩
```
...
├── 05_osint_defense_and_counter_intelligence.md ← OSINT 방어 및 대항 인텔리전스 — 디지털 발자국 최소화·소셜 엔지니어링 인식·피싱 방어
└── 06_osint_ctf_lab.md                 ← OSINT & 소셜 엔지니어링 CTF 실습 랩
```
...
├── 04_hardware_security_assessment.md     ← 하드웨어 보안 평가 — 디바이스 감사·물리 보안·탬퍼 방지
├── 05_hardware_security_defense.md        ← 하드웨어 보안 방어 — 시큐어 부트·TPM·물리 보안·변조 감지
└── 06_hardware_ctf_lab.md                 ← 하드웨어 해킹 CTF 실습 랩
```
...
├── 03_Dependency_Confusion_and_Typosquatting.md ← 의존성 혼동 공격 및 타이포스쿼팅
├── 04_Open_Source_Backdoor_Techniques.md ← 오픈소스 백도어 삽입 기법
├── 05_supply_chain_defense.md    ← 공급망 보안 방어 — SBOM·의존성 스캔·벤더 위험 관리
└── 06_supply_chain_ctf_lab.md    ← 공급망 공격 CTF 실습 랩
```
...
├── 04_automotive_security_testing.md ← 자동차 보안 테스트 — 침투 테스트·퍼징·인증 검증
├── 05_automotive_security_defense.md ← 자동차 사이버보안 방어 — ISO/SAE 21434·UNECE WP.29·안전한 OTA 업데이트
└── 06_automotive_ctf_lab.md         ← 자동차 해킹 CTF 실습 랩
```
...
├── 04_ics_security_architecture.md ← 04 — ICS 보안 아키텍처 및 방어 전략
├── 05_ics_security_defense.md     ← ICS/SCADA 보안 방어 — IEC 62443·네트워크 분리·OT 모니터링
└── 06_ics_ctf_lab.md              ← ICS/SCADA CTF 실습 랩
```
...
├── 05_cloud_native_defense.md           ← 05 — Cloud Native 보안 방어 체계
└── 06_cloud_native_ctf_lab.md           ← 클라우드 네이티브 보안 CTF 랩
```
...
├── 05_zero_trust_maturity.md           ← 05 — Zero Trust 성숙도 평가 및 운영
└── 06_zero_trust_ctf_lab.md            ← 제로 트러스트 아키텍처 CTF 랩
```
...
├── 05_threat_hunting_program.md      ← 05 — 위협 헌팅 프로그램 운영
└── 06_threat_hunting_ctf_lab.md      ← 위협 헌팅 CTF 랩
```
...
└── 06_korean_cert_ctf_lab.md                     ← 한국 정보보안 자격증 CTF 실습 랩
```
...
├── 05_web3_incident_response.md               ← Web3 사고 대응
└── 06_blockchain_ctf_lab.md                   ← 블록체인 / Web3 보안 CTF 실습 랩
```
...
├── 05_physical_security_assessment.md          ← 물리적 보안 평가
└── 06_physical_ctf_lab.md                      ← 물리 보안 침투 테스트 CTF 실습 랩
```
...
├── 05_malware_triage_and_containment.md       ← 악성코드 트리아지 및 억제
└── 06_ir_dfir_ctf_lab.md                      ← 침해사고 대응 / DFIR CTF 실습 랩
```
...
├── 05_detection_resistant_techniques.md        ← 탐지 저항 기법 분석 (방어자 관점)
└── 06_malware_dev_ctf_lab.md                   ← 악성코드 개발 / 분석 CTF 실습 랩
```
...
├── 05_ctf_writeup_methodology.md       ← CTF 라이트업 작성 방법론
└── 06_advanced_ctf_practical_lab.md    ← 고급 CTF 실습 랩 — Pwn·Crypto·Forensics·Misc 종합
```
...
├── 05_mobile_malware_analysis.md    ← 모바일 악성코드 분석
└── 06_mobile_forensics_ctf_lab.md   ← 모바일 포렌식 CTF 실습 랩
```
...
├── 05_ai_system_threat_modeling.md  ← AI 시스템 위협 모델링
└── 06_threat_modeling_ctf_lab.md    ← 위협 모델링 CTF 실습 랩
```
...
├── 05_red_team_detection_evasion.md  ← 레드팀 인프라 탐지 우회 (방어자 관점)
└── 06_red_team_infra_ctf_lab.md      ← 레드팀 인프라 CTF 실습 랩
```
...
├── 05_game_server_exploitation.md   ← 게임 서버 취약점 연구
└── 06_game_ctf_lab.md               ← 게임 해킹 CTF 실습 랩
```
...
├── 05_extension_malware_campaigns.md  ← 브라우저 확장 프로그램 악성 캠페인 분석
└── 06_browser_extension_ctf_lab.md    ← 브라우저 확장 프로그램 보안 CTF 실습 랩
```
...
├── 05_api_security_testing_automation.md ← API 보안 테스트 자동화 파이프라인
└── 06_api_ctf_lab.md                     ← CTF: API 취약점 실습 랩
```
...
├── 05_serverless_incident_response.md ← 서버리스 사고 대응·CloudTrail 분석·자동 격리
└── 06_serverless_ctf_lab.md           ← CTF: Lambda 환경변수·이벤트 인젝션·IAM 남용 실습
```
...
├── 05_ad_defense_and_detection.md  ← AD 이벤트 모니터링·하니팟 계정·강화 체크리스트
└── 06_ad_ctf_lab.md                ← CTF: Kerberoasting·공격 경로 분석·DCSync 실습
```
...
├── 05_evasion_detection_and_hunting.md ← 회피 기법 위협 헌팅·탐지 룰·행위 분석
└── 06_evasion_ctf_lab.md               ← CTF: 인코딩 우회·로그 조작 탐지 실습
```
...
```
56_AI_Red_Teaming/
├── 01_ai_attack_fundamentals.md    ← AI 공격 기초, 공격 표면, 위협 모델링
├── 02_prompt_injection.md          ← 직접·간접·다중 모달 인젝션, 탈옥 기법
├── 03_model_extraction.md          ← 모델 추출·멤버십 추론, 쿼리 기반 공격
├── 04_adversarial_examples.md      ← FGSM/PGD, 전이 공격, 방어 기법
├── 05_ai_red_team_defense.md       ← 모델 강화, 입력 검증, AI 보안 아키텍처
└── 06_ai_red_team_ctf_lab.md       ← CTF: 프롬프트 인젝션·모델 추출 실습
```
...
├── 04_nist_pqc_standards.md        ← NIST PQC 표준화 과정, FIPS 203/204/205
├── 05_pqc_migration_strategy.md    ← 하이브리드 암호화, 암호 자산 인벤토리, 마이그레이션 전략
└── 06_quantum_crypto_ctf_lab.md    ← CTF: 양자 암호 원리·PQC 실습
```
...
```
58_Cloud_IR/
├── 01_cloud_ir_fundamentals.md     ← Cloud IR 프레임워크, AWS/Azure/GCP 침해 지표
├── 02_aws_forensics.md             ← CloudTrail 분석, S3/EC2 포렌식, GuardDuty 연동
├── 03_azure_forensics.md           ← Azure Sentinel 조사, Activity Log 분석
├── 04_gcp_forensics.md             ← GCP Chronicle, Audit Log 포렌식
├── 05_cloud_threat_hunting.md      ← 클라우드 위협 헌팅, 이상 탐지, KQL 쿼리
└── 06_cloud_ir_ctf_lab.md          ← CTF: CloudTrail 분석·침해 시나리오 실습
```
...
├── 01_supply_chain_fundamentals.md     ← 공급망 공격 유형, 침해 지표, 위협 모델
├── 02_software_supply_chain_attacks.md ← SolarWinds·Codecov 등 실제 사례, 탐지 전략
├── 03_dependency_confusion.md          ← 의존성 혼동 공격, 타이포스쿼팅, 방어
├── 04_build_integrity.md               ← 빌드 무결성 검증, 서명, SLSA 프레임워크
├── 05_supply_chain_defense.md          ← SBOM 관리, 벤더 위험 관리, 방어 전략
└── 06_supply_chain_ctf_lab.md          ← CTF: 의존성 혼동·SBOM 분석 실습
```
...
├── 02_javascript_engine_exploitation.md ← V8/SpiderMonkey 취약점, JIT 컴파일러 버그
├── 03_sandbox_escape.md                 ← 샌드박스 탈출 기법, 프로세스 격리 우회
├── 04_browser_extension_advanced.md     ← 악성 확장 분석, MV3 보안 모델
├── 05_browser_security_hardening.md     ← 브라우저 보안 설정, 엔터프라이즈 정책
└── 06_browser_security_ctf_lab.md       ← 브라우저 보안 CTF 실습 랩
```
...
```
61_Firmware_Hacking/
├── 01_firmware_fundamentals.md     ← 펌웨어 유형, 추출 방법, 분석 환경 구성
├── 02_firmware_extraction.md       ← JTAG/UART/SPI 덤프, binwalk 추출, 파일시스템 마운트
├── 03_firmware_analysis.md         ← Ghidra 역분석, 취약 함수 탐지, 하드코딩 비밀
├── 04_firmware_emulation.md        ← QEMU 에뮬레이션, firmwalker, 동적 분석
├── 05_firmware_exploitation.md     ← 버퍼 오버플로, 커맨드 인젝션, 웹 인터페이스 공격
└── 06_firmware_ctf_lab.md          ← CTF: 펌웨어 추출·분석·익스플로잇 실습
```
...
├── 01_automotive_security_fundamentals.md ← 자동차 네트워크 아키텍처, CAN/LIN/FlexRay
...
├── 05_automotive_penetration_testing.md   ← 자동차 침투 테스트 방법론, 보고서 작성
└── 06_automotive_ctf_lab.md               ← CTF: CAN 버스·UDS·ECU 실습
```
...
```
63_OT_ICS_Advanced/
├── 01_ot_ics_fundamentals.md       ← OT/ICS 아키텍처, Purdue 모델, 주요 프로토콜
...
├── 05_ot_defense_and_monitoring.md ← OT 보안 아키텍처, 네트워크 분리, 이상 탐지
└── 06_ot_ics_ctf_lab.md            ← CTF: Modbus·PLC·SCADA 실습
```
...
├── 01_tip_fundamentals.md            ← TIP 아키텍처, 데이터 모델(STIX 2.1), 플랫폼 비교
├── 02_misp_platform.md               ← MISP 설치·운영, 이벤트 관리, API 자동화
├── 03_threat_feeds_and_enrichment.md ← 위협 피드 수집·품질 평가·IoC 인리치먼트
├── 04_ioc_management.md              ← IOC 라이프사이클, 노이즈 감소, TAXII 연동
├── 05_tip_automation.md              ← SOAR 연동, 자동 대응, 위협 피드 오케스트레이션
└── 06_tip_ctf_lab.md                 ← CTF: MISP 이벤트·IOC 분석 실습
```
